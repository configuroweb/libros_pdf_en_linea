		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					...
					<small class="text-info"><i>Deje este espacio en blanco si no desea cambiar la contraseña.</i></small>
                    <?php endif; ?>
				</div>
				<div class="form-group col-6">
					...
					<select name="type" id="type" class="custom-select"  required>
						...
						<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected': '' ?>>Autor</option>
					</select>
				</div>
				<div class="form-group col-6">
